...
describe("Key", () => {
	...
	it("signing", async () => {
		const issuer = userwidgets.User.Key.Issuer.create<userwidgets.User.Key>(
			"userwidgets",
			"myAudience",
	...
	it("signing and verifying", async () => {
		...
		const issuer = userwidgets.User.Key.Issuer.create("userwidgets", "example", publicKey, privateKey)
		const verifierPublicKey = userwidgets.User.Key.Verifier.create(publicKey)
